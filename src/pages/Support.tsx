    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="p-4 flex-1">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-5 shadow-lg border border-green-100">
            ...
            <Button 
              ...
              onClick={() => window.open('https://t.me/+TV_2VgXPMugyYjA8')}
            >
              Chat on WhatsApp
            </Button>
          </div>
        ...
        <div className="mt-6 text-center">
          ...
          <p className="text-blue-600 font-medium mt-1 text-sm">https://chat.whatsapp.com/EGg6uVsUoKS0qh4BeENdoq?mode=gi_t</p>
        </div>
      </div>
    </div>
  );
